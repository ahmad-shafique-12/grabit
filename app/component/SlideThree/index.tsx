...
const SlideThree = () => {
    ...
    // const [filterdata2, setFilterData]: any = useState(data.slice(3,6));
    const [filterdata3, setFilterData]: any = useState(data.slice(6,9));
    ...
    return (
        <>
            <div className='xl:w-[25%] sm:w-[49%] w-[100%]   relative'>
                <h1 className='text-[#303030] text-[25px] font-[600]'>Top <span className='text-[#5CAF90]'>Selling</span></h1>
                <div className="slider-container ">
                    <Slider {...settings}>

                        {
                            filterdata3.map((e: any, i: any) => {
                                return (<>
                                    <div className='p-2 '>
                                                ...
                                                return (<>
                                                    <div className='p-2'>
                                                        ...
                                                        <div className='border  p-2 flex items-center gap-5 justify-between group '>
                                                            ...
                                                            <div className=''>
                                                                <p className='text-[14px] font-[500] text-[gray]'>{e.name.length > 7 ? `${e.name.substring(0, 7)}...` : e.name}</p>
